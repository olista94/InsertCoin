...
public class GestorBD extends SQLiteOpenHelper {
    ...
    public ArrayList<juegos> obtenerDatosPelis(SQLiteDatabase db){
        ...
        while(datos.moveToNext()){
            lista.add(new juegos(datos.getLong(0), datos.getString(1), datos.getString(2), datos.getString(3), datos.getString(4), datos.getString(5), datos.getString(6), datos.getString(7), datos.getInt(8), datos.getString(9), datos.getString(10)));
        }
