...
public class GestorBD extends SQLiteOpenHelper implements Serializable {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO juegos (titulo, portada, descripcion, genero, plataforma, nacionalidad, compania, anho, edad_recomendada) VALUES ('Soul Calibur','soulcalibur','Luchas entre personajes con poderes unicos','Lucha','PS1, Arcade','Japon','Namco',1995,'+13')");
        ...
        db.execSQL("INSERT INTO comenta (login, titulo, comentario) VALUES ('olrivera','Super Mario 64','Buenos recuerdos de mi infancia')");
        db.execSQL("INSERT INTO comenta (login, titulo, comentario) VALUES ('ypgarcia','Super Mario 64','Me encanta jugar con Luigi')");
        db.execSQL("INSERT INTO comenta (login, titulo, comentario) VALUES ('ritaconde','Grandt Theft Auto V','Estoy muy enganchada a este juego')");
        db.execSQL("INSERT INTO comenta (login, titulo, comentario) VALUES ('ritaconde','NBA2K11','Juegazo')");

        db.execSQL("INSERT INTO puntua (login, titulo, puntuacion) VALUES ('olrivera','Super Mario 64',5.0)");
        db.execSQL("INSERT INTO puntua (login, titulo, puntuacion) VALUES ('ypgarcia','Super Mario 64',4.0)");
        db.execSQL("INSERT INTO puntua (login, titulo, puntuacion) VALUES ('abelardoglez','Red Dead Redemption 2',5.0)");
        db.execSQL("INSERT INTO puntua (login, titulo, puntuacion) VALUES ('abelardoglez','Fortnite',3.5)");
    ...
    public void addComentario(String login, String titulo, String comentario){
        ...
        try {
            ...
            Log.d("DBManager","Insertado correctamente");
        }catch (SQLException exc){
            Log.d("DBManager","Error al insertar");
        }finally {
            db.endTransaction();
        }
    }
    ...
    public void addUsuario(String login, String password, String nombre, String apellidos, String email){
        ...
        try {
            ...
            db.setTransactionSuccessful();
            VariablesGlobales.setMensajeBD("Logueado con exito");
        }catch (SQLException exc){
    ...
    public void addJuego(String titulo, String portada, String descripcion, String genero, String plataforma, String nacionalidad, String compania, int anho, String edadRecomendada){
        ...
        try {
            ...
            db.setTransactionSuccessful();
            VariablesGlobales.setMensajeBD("Juego añadido con exito");
        }catch (SQLException exc){
    ...
    public void updateJuego(String titulo,String descripcion, String genero, String plataforma, String nacionalidad, String compania, int anho, String edadRecomendada){
        ...
        SQLiteDatabase db = this.getWritableDatabase();
            ...
            db.setTransactionSuccessful();
            VariablesGlobales.setMensajeBD("Datos actualizados correctamente");
            db.endTransaction();
    ...
    public void addPuntuacion(String login, String titulo, float puntuacion){
        ...
        try {
            ...
            VariablesGlobales.setMensajeBD("Error al asignar valoracion");
        }finally {
            db.endTransaction();
        }
    }
